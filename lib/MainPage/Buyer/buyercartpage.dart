...
import 'package:barter_it/MainPage/Buyer/billpage.dart';
import 'package:barter_it/Model/cart.dart';
...
class _BuyerCartPageState extends State<BuyerCartPage> {
                      ...
                      itemBuilder: (context, index) {
                        return Dismissible(
                          ...
                          direction: DismissDirection
                              .endToStart, // Restrict to left-to-right swipe
                          ...
                          secondaryBackground: Container(
                            color: Colors
                                .red, // Background color when revealing delete button
                            ...
                            child: Row(
                              children: [
                                CachedNetworkImage(
                                  ...
                                  fit: BoxFit.cover,
                                  imageUrl:
                                      "https://uumitproject.com/barterIt/assets/items/${cartList[index].itemId}.1.png",
  ...
  void loadcart() {
    http.post(
        Uri.parse("https://uumitproject.com/barterIt/buyer/load_cart.php"),
        body: {
  ...
  void updateCart(int index, int newqty, double newprice) {
    http.post(
        Uri.parse("https://uumitproject.com/barterIt/buyer/update_cart.php"),
        body: {
  ...
  void deleteCart(int index) {
    http.post(
        Uri.parse("https://uumitproject.com/barterIt/buyer/delete_cart.php"),
        body: {
          "cartid": cartList[index].cartId,
        }).then((response) {
      if (response.statusCode == 200) {
