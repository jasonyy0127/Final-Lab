...
import 'package:barter_it/MainPage/Buyer/buyerorderhistorydetails.dart';
...
class BuyerOrderHistory extends StatefulWidget {
  const BuyerOrderHistory({Key? key, required this.user}) : super(key: key);
...
class _BuyerOrderHistoryState extends State<BuyerOrderHistory> {
  ...
  void loadbuyerorderhistory() {
    http.post(
        Uri.parse(
            "https://uumitproject.com/barterIt/buyer/load_buyer_orderhistory.php"),
