...
import 'package:barter_it/MainPage/Seller/salehistorydetailspage.dart';
...
class _SaleHistoryPageState extends State<SaleHistoryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Your Sale History"),
  ...
  void loadsalehistory() {
    http.post(
        Uri.parse(
            "https://uumitproject.com/barterIt/seller/load_seller_orderhistory.php"),
